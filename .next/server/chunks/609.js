...
// Exports
module.exports = {
	"modalchildren": "modal_modalchildren__W9pwe"
};
...
;// CONCATENATED MODULE: ./components/login.tsx
...
;// CONCATENATED MODULE: ./components/register.tsx
...
function Header() {
    ...
    const createNewTypeMode = (0,external_react_redux_.useSelector)((state)=>state.user_store.createNewTypeMode
    );
    const dispatch = (0,external_react_redux_.useDispatch)();
    const router = (0,router_.useRouter)();
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex items-center flex-wrap justify-between p-5 bg-black rounded-3xl text-white text-2xl font-bold",
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                    className: "bg-black rounded-3xl p-5 text-white text-2xl font-bold mt-2",
                        ...
                        user.currentTab == TabName.CLASS && createNewTypeMode && /*#__PURE__*/ jsx_runtime_.jsx(modal/* default */.Z, {
                            modalId: "create_class_modal",
                            modalOpen: userSlice/* setCreateNewTypeMode */.uf,
                            children: /*#__PURE__*/ jsx_runtime_.jsx(NewClass, {})
                        }),
                        user.currentTab == TabName.GROUP && createNewTypeMode && /*#__PURE__*/ jsx_runtime_.jsx(modal/* default */.Z, {
...
/* harmony import */ var _modal_module_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5155);
