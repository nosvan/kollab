...
async function handle(req, res) {
    if (req.method === "POST") {
        ...
        try {
            const result = await lib_prisma__WEBPACK_IMPORTED_MODULE_2__/* ["default"].classroom.create */ .Z.classroom.create({
                select: {
                    id: true,
                    name: true,
                    school_name: true,
            ...
            const safeResult = {
                ...
                semester: lib_types_class__WEBPACK_IMPORTED_MODULE_3__/* .Semester */ .h[result.semester],
...
var __webpack_exports__ = __webpack_require__.X(0, [534], () => (__webpack_exec__(3473)));
