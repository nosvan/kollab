...
/* harmony import */ var lib_types_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8906);
    ...
    if (req.method === "GET") {
        ...
        try {
            const result = await lib_prisma__WEBPACK_IMPORTED_MODULE_2__/* ["default"].item.findMany */ .Z.item.findMany({
                ...
                where: {
                    category: _prisma_client__WEBPACK_IMPORTED_MODULE_3__.Category.personal,
            ...
            result.forEach((row)=>{
                const itemRow = {
                    ...
                    category: lib_types_item__WEBPACK_IMPORTED_MODULE_4__/* .Category */ .W[row.category.toUpperCase()],
                    category_id: row.category_id,
                    item_type: lib_types_item__WEBPACK_IMPORTED_MODULE_4__/* .ItemType */ .q[row.item_type.toUpperCase()],
...
var __webpack_exports__ = __webpack_require__.X(0, [534,133], () => (__webpack_exec__(3325)));
