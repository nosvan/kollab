...
/* harmony import */ var components_task_view__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(2973);
/* harmony import */ var utils_dateUtils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(6607);
...
function Groups({ user  }) {
    ...
    const currentGroup = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.useSelector)((state)=>state.group_store.group
    );
    const userGroups = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.useSelector)((state)=>state.group_store.groups
    );
    const groupItems = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.useSelector)((state)=>state.group_store.items
    );
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
    ...
    const { 0: days , 1: setDays  } = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(()=>(0,utils_dateUtils__WEBPACK_IMPORTED_MODULE_13__/* .getDays */ .gw)(dayLayout, selectedDate)
    );
    (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(()=>{
        setDays((0,utils_dateUtils__WEBPACK_IMPORTED_MODULE_13__/* .getDays */ .gw)(dayLayout, selectedDate));
    }, [
        dayLayout,
        selectedDate
    ]);
            ...
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            userGroups && userGroups.length > 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("select", {
                                value: currentGroup.id,
                                onChange: handleDropdownSelect,
                                name: "groups",
                                id: "groups-select",
                                className: "rounded-lg text-white bg-stone-800 hover:bg-stone-700 cursor-pointer text-base p-1 ml-1",
                                children: userGroups.map((group)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("option", {
                                        value: group.id,
                                        className: "relative",
                                        children: [
                                            group.name,
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: "flex flex-row items-center space-x-1 bg-stone-800 rounded-lg p-1 mx-1",
                                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_task_view__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z, {
                        dayLayout: dayLayout,
                        days: days,
    ...
    function handleIncrementDate() {
        setSelectedDate((0,utils_dateUtils__WEBPACK_IMPORTED_MODULE_13__/* .incrementDate */ .xA)(selectedDate, dayLayout));
    }
    function handleDecrementDate() {
        setSelectedDate((0,utils_dateUtils__WEBPACK_IMPORTED_MODULE_13__/* .decrementDate */ .wM)(selectedDate, dayLayout));
    }
    ...
    function handleDropdownSelect(event) {
        ...
        const group1 = userGroups.find((group)=>group.id == groupId
        );
...
var __webpack_exports__ = __webpack_require__.X(0, [531,145,609,973], () => (__webpack_exec__(9759)));
