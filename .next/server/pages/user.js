...
/* harmony import */ var _lib_prisma__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75);
...
const getServerSideProps = (0,iron_session_next__WEBPACK_IMPORTED_MODULE_1__/* .withIronSessionSsr */ .c)(async function getServerSideProps(context) {
    ...
    if (t0k3n) {
        try {
            ...
            const result = await _lib_prisma__WEBPACK_IMPORTED_MODULE_3__/* ["default"].user.findUnique */ .Z.user.findUnique({
                select: {
                    id: true,
                    first_name: true,
                    last_name: true,
...
var __webpack_exports__ = __webpack_require__.X(0, [531,193], () => (__webpack_exec__(321)));
